...
(() => {
    ...
    var we = (t, e, r, n) => {
        if ((e && typeof e == "object") || typeof e == "function") for (let i of Qe(e)) !X.call(t, i) && i !== r && U(t, i, { get: () => e[i], enumerable: !(n = Se(e, i)) || n.enumerable });
        return t;
    };
    var Pe = (t, e, r) => ((r = t != null ? xe(Ee(t)) : {}), we(e || !t || !t.__esModule ? U(r, "default", { value: t, enumerable: !0 }) : r, t));
    var B = (t, e, r) =>
        new Promise((n, i) => {
            var s = (u) => {
                    try {
...
`,
             ...
             */ (t.Vector = function (e) {
                ...
                (t.Vector.prototype.dot = function (e) {
                    for (var r = 0, n = this.elements, i = e.elements, s = n.length, o = i.length, a = 0, u = 0, c = 0, f = 0; c < s && f < o; )
                        (a = n[c]), (u = i[f]), a < u ? (c += 2) : a > u ? (f += 2) : a == u && ((r += n[c + 1] * i[f + 1]), (c += 2), (f += 2));
                    return r;
                }),
                        ...
                        if (s.editsRemaining != 0) {
                            ...
                            if (s.str.length > 1) {
                                var f = s.str.charAt(0),
                                    g = s.str.charAt(1),
                                    l;
                                g in s.node.edges ? (l = s.node.edges[g]) : ((l = new t.TokenSet()), (s.node.edges[g] = l)),
                                    s.str.length == 1 && (l.final = !0),
                                    i.push({ node: l, editsRemaining: s.editsRemaining - 1, str: f + s.str.slice(2) });
                            }
                        }
                    }
                    return n;
                            ...
                            for (var f = s[c], g = 0; g < u; g++) {
                                ...
                                if (l == f || f == "*") {
                                    var m = n.node.edges[l],
                                        ...
                                        v = m.final && x.final,
                                        d = void 0;
                                    l in n.output.edges ? ((d = n.output.edges[l]), (d.final = d.final || v)) : ((d = new t.TokenSet()), (d.final = v), (n.output.edges[l] = d)), i.push({ qNode: x, output: d, node: m });
                                }
                            }
                    }
                    return r;
                    ...
                    for (var e = {}, r = Object.keys(this.fieldTermFrequencies), n = r.length, i = Object.create(null), s = 0; s < n; s++) {
                        for (
                            ...
                            var d = g[v],
                                ...
                                w,
                                R;
                            i[d] === void 0 ? ((E = t.idf(this.invertedIndex[d], this.documentCount)), (i[d] = E)) : (E = i[d]),
    ...
    function ne(t) {
        ...
        // Bapt - Normalize
        e.forEach(value => {
            value.title = value.title.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
            value.text = value.text.normalize('NFD').replace(/[\u0300-\u036f]/g, '');
        })
    ...
    function ie(t, e) {
        ...
        for (let s = 0; i < t.length; i++)
            t.charAt(i) === "<" && i > n ? e(r, 1, n, (n = i)) : t.charAt(i) === ">" && (t.charAt(n + 1) === "/" ? --s === 0 && e(r++, 2, n, i + 1) : t.charAt(i - 1) !== "/" && s++ === 0 && e(r, 0, n, i + 1), (n = i + 1));
        i > n && e(r, 1, n, i);
    }
                            ...
                            if (typeof lunr.segmenter != "undefined") {
                                ...
                                if (/^[MHIK]$/.test(lunr.segmenter.ctype_(x))) {
                                    ...
                                    for (let d = 0, y = 0; d < v.length; d++)
                                        i[o] || (i[o] = []), i[o].push(((u + l + y) << 12) | (v[d].length << 2) | a), e.push(new lunr.Token(v[d].toLowerCase(), { position: (o << 20) | (i[o].length - 1) })), (y += v[d].length);
                                    return;
                                }
                            }
    ...
    function ce(t) {
        ...
        for (let n of e.clauses)
            (n.usePipeline = !0), n.term.startsWith("*") && ((n.wildcard = lunr.Query.wildcard.LEADING), (n.term = n.term.slice(1))), n.term.endsWith("*") && ((n.wildcard = lunr.Query.wildcard.TRAILING), (n.term = n.term.slice(0, -1)));
        return e.clauses;
    }
    function le(t, e) {
        var i;
        let r = new Set(t),
            n = {};
        // Bapt - Normalize
        r.forEach(value => value.term = value.term.normalize('NFD').replace(/[\u0300-\u036f]/g, ''));
        ...
        constructor({ config: e, docs: r, options: n }) {
            ...
            (this.map = ne(r)),
                ...
                (this.index = lunr(function () {
                    ...
                    this.ref("location"), this.field("title", { boost: 1e3, extractor: i("title") }), this.field("text", { boost: 1, extractor: i("text") }), this.field("tags", { boost: 1e6, extractor: i("tags") });
                    for (let o of r) this.add(o, { boost: o.boost });
                }));
        }
        search(e) {
            if (((e = e.replace(new RegExp("\\p{sc=Han}+", "gu"), (s) => [...he(s, this.index.invertedIndex)].join("* "))), (e = ue(e)), !e)) return { items: [] };
            ...
            if (this.options.suggest) {
                let s = this.index.query((o) => {
                    for (let a of r) o.term(a.term, { fields: ["title"], presence: lunr.Query.presence.REQUIRED, wildcard: lunr.Query.wildcard.TRAILING });
                });
            ...
            switch (t.type) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        return console.warn(`Invalid query: ${e} \u2013 see https://bit.ly/2s3ChXG`), console.warn(r), { type: 3, data: { items: [] } };
                    }
                default:
